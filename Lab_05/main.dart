...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Consumer<MortgageCalculator>(
...
class _ModifyDataScreenState extends State<ModifyDataScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final calc = Provider.of<MortgageCalculator>(context, listen: false);
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                calc._amount = double.tryParse(_amountController.text) ?? 0.0;
                calc._rate = _rateValue;
                calc._years = int.parse(_yearController.text);
                Navigator.push(
                  context,
...
class MortgageCalculator extends ChangeNotifier {
  ...
  }) : assert(_years >= 0 && _amount >= 0 && _rate >= 0);
  ...
  double get monthlyPayment {
    ...
    double finalValue =
        this._amount * ((this.monthRate * periodRate) / (periodRate - 1));
